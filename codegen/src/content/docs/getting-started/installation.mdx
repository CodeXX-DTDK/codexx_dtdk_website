...
<Tabs tabs={[
  ...
  <div>
    <LinkButton href="https://www.codexx-dtdk.com/api/download?platform=linux&arch=x64" variant="primary">Download DTDK Manager — Linux x64</LinkButton>
  ...
  <div>
    <LinkButton href="https://www.codexx-dtdk.com/api/download?platform=windows&arch=x64" variant="primary">Download DTDK Manager — Windows x64</LinkButton>
