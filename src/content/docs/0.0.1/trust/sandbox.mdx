...
description: How the LuaU VM sandbox prevents rules from accessing the
  filesystem, network, or process environment, and what this means for supply
  chain security.
slug: 0.0.1/trust/sandbox
---

See [LuaU Sandbox](/0.0.1/rules/luau-sandbox/) for the technical details of what is and is not available inside rule scripts.
