...
docsgen is the terminal stage of the [codex](https://www.codexx-dtdk.com) C++ analysis pipeline. It does not parse C++ itself — it consumes the symbol database codex produces and renders it.
